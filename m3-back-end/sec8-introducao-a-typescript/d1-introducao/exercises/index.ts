...
console.log('\nCALCULA ÁREA DE UM LOSANGO:');

console.log(`- D = 32cm e d = 18cm: ${Ex.getRhombusArea(32, 18)}cm`);
console.log(`- D = 200cm e d = 50cm: ${Ex.getRhombusArea(200, 50)}cm`);
console.log(`- D = 75cm e d = 25cm: ${Ex.getRhombusArea(75, 25)}cm`);

console.log('A ÁREA DE UM:');

console.log(
  `- Trapézio com base maior igual a 100cm, base menor igual a 70cm e altura igual a 50cm: ${Ex.getTrapezoidArea(
    100,
    70,
    50
  )}cm²`
...
console.log(
  `- Trapézio com base maior igual a 75cm, base menor igual a 50cm e altura igual a 35cm: ${Ex.getTrapezoidArea(
    75,
    50,
    35
  )}cm²`
...
console.log(
  `- Trapézio com base maior igual a 150cm, base menor igual a 120cm e altura igual a 80cm: ${Ex.getTrapezoidArea(
    150,
    120,
    80
  )}cm²`
