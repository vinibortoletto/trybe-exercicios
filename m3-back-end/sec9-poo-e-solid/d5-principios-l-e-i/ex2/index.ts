...
class Flight {
  constructor(
    public num: number,
    public payload: (ShippedItem | Passenger)[]
  ) {}

  Add(newPayload: ShippedItem | Passenger): void {
    this.payload.push(newPayload);
  }

  Remove(removedPayload: ShippedItem | Passenger): void {
